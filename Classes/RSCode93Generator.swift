    ...
    override func isValid(contents: String) -> Bool {
        if contents.length() > 0 && contents == contents.uppercaseString {
            for i in 0..contents.length() {
                if CODE93_ALPHABET_STRING.location(contents.substring(i, length: 1)) == NSNotFound {
                    return false
                }
            }
            return true
